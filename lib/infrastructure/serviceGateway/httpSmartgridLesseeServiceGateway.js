...
class Gateway {
    ...
    getStation(stationID, traceContext, callback) {
        var url = `http://${SMARTGRID_LESSEE_SERVICE_HOST}:${SMARTGRID_LESSEE_SERVICE_PORT}/stations/${stationID}`;
        var options = {
            method: "GET",
            path: url,
            entity: {
    ...
    registerPermission(permissionData, traceContext, callback) {
        var url = `http://${SMARTGRID_LESSEE_SERVICE_HOST}:${SMARTGRID_LESSEE_SERVICE_PORT}/permissions`;
        var options = {
            method: "POST",
            path: url,
            entity: {
    ...
    delPermission(permissionID, traceContext, callback) {
        var url = `http://${SMARTGRID_LESSEE_SERVICE_HOST}:${SMARTGRID_LESSEE_SERVICE_PORT}/permissions/${permissionID}`;
        var options = {
            method: "DELETE",
            path: url,
            entity: {
