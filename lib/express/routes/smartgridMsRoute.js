...
router.post('/lessees', (req, res)=> {
    ...
    smartgridLesseeService.addLessee(lesseeData, traceContext, (err, isSuccess)=> {console.log(lesseeData);
        if (err) {
...
router.get('/lessees', (req, res)=> {
    ...
    let smartgridLesseeService = req.app.get('smartgridLesseeService');
    let traceContext = traceContextFeach(req);
    smartgridLesseeService.getLessees(lesseeID, traceContext, (err, lesseesJSON)=> {
        if (err) {
            logger.error(err.message, traceContext);
            return;
        }
        ...
        resultJSON.errcode = errCodeTable.OK.errCode;
        resultJSON.errmsg = errCodeTable.OK.errMsg;
        resultJSON.lesseesJSON = lesseesJSON;
        res.json(resultJSON);
...
router.get('/stations', (req, res)=> {
    ...
    let smartgridLesseeService = req.app.get('smartgridLesseeService');
    let traceContext = traceContextFeach(req);
    smartgridLesseeService.getStations(stationID, traceContext, (err, stationsJSON)=> {
        if (err) {
            logger.error(err.message, traceContext);
            return;
        }
        ...
        resultJSON.errcode = errCodeTable.OK.errCode;
        resultJSON.errmsg = errCodeTable.OK.errMsg;
        resultJSON.stationsJSON = stationsJSON;
        res.json(resultJSON);
...
router.get('/dataSources', (req, res)=> {
    ...
    let dataSourceService = req.app.get('smartgridLesseeService');
    let traceContext = traceContextFeach(req);
    dataSourceService.getDataSources(dataSourceID, traceContext, (err, dataSourcesJSON)=> {
        if (err) {
            logger.error(err.message, traceContext);
            return;
        }
        ...
        resultJSON.errcode = errCodeTable.OK.errCode;
        resultJSON.errmsg = errCodeTable.OK.errMsg;
        resultJSON.dataSourcesJSON = dataSourcesJSON;
        res.json(resultJSON);
...
router.post('/permissions', (req, res)=> {
    ...
    let permissionService = req.app.get('smartgridLesseeService');
    let traceContext = traceContextFeach(req);
    permissionService.addPermission(permissionData, traceContext, (err, isSuccess)=> {
        if (err) {
            logger.error(err.message, traceContext);
            return;
        }
...
router.delete('/permissions/:permissionID', (req, res)=> {
    ...
    let permissionService = req.app.get('smartgridLesseeService');
    let traceContext = traceContextFeach(req);
    permissionService.delPermission(permissionID, traceContext, (err, isSuccess)=> {
        if (err) {
            logger.error(err.message, traceContext);
            return;
        }
...
router.get('/permissions', (req, res)=> {
    ...
    let permissionService = req.app.get('smartgridLesseeService');
    let traceContext = traceContextFeach(req);
    permissionService.getPermission(permissionID, traceContext, (err, permissionsJSON)=> {
        if (err) {
            logger.error(err.message, traceContext);
            return;
        }
        ...
        resultJSON.errcode = errCodeTable.OK.errCode;
        resultJSON.errmsg = errCodeTable.OK.errMsg;
        resultJSON.permissionsJSON = permissionsJSON;
        res.json(resultJSON);
